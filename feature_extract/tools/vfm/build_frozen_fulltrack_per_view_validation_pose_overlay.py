"""Build a validation-only pose overlay from a frozen full-track probe."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = build_frozen_fulltrack_per_view_validation_pose_overlay(
        features=load_frozen_fulltrack_per_view_appearance_features(
            args.appearance_artifacts
        ),
