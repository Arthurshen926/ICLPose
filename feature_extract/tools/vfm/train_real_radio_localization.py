"""Train the real-image measurement branch for RADIO/MATCHA localization."""
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--query_source", default="real_pair", choices=("real_pair",))
    parser.add_argument("--support_patch_warp", default="none", choices=("none", "local_affine", "local_homography"))
    parser.add_argument("--render_patch_augmentation", default="none", choices=("none",))
    ...
    parser.add_argument("--train_stage", default="real_pair_measurement")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    summary = train_rgb_patch_measurement_branch(
        ...
        render_image_width=int(args.reference_image_width) if int(args.reference_image_width) > 0 else None,
        render_image_height=int(args.reference_image_height) if int(args.reference_image_height) > 0 else None,
