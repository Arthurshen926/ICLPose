...
b=Path('output/g25_pose_transport/planar_map_rendered_ransac_v1/surface_coordinate_upgrade_v1');r=b/'spatial_verifier_v404';fit=joblib.load(r/'verifier.joblib');model=fit['model'];meta=fit['metadata'];assert not meta['query_routes_read'];scale,bias=meta['calibration'];threshold=meta['threshold'];sources={str(r/'verifier.joblib'):file_sha256(r/'verifier.joblib')}
...
for folder,rawfolder,arm,label in [('overlap_lod_v402/lod_fixed_final','overlap_lod_v402/lod_fixed','mnn','mnn_seed1'),('overlap_lod_v402/lod_seed2_final','overlap_lod_v402/lod_seed2','mnn','mnn_seed2'),('overlap_weighted_v403/lod_final','overlap_weighted_v403/lod','weighted_mnn','soft_seed1'),('overlap_weighted_seed2_v403/lod_final','overlap_weighted_seed2_v403/lod','weighted_mnn','soft_seed2')]:
 o=r/label;o.mkdir(exist_ok=True)
