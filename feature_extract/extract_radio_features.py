#!/usr/bin/env python3
"""Canonical FeatureExtract RADIO feature extraction entrypoint.
...
用法:
    CUDA_VISIBLE_DEVICES=5 python -m feature_extract.extract_radio_features \
...
def main():
    ...
    parser.add_argument('--radio_repo', type=str, default='feature_extract/checkpoints/RADIO',
