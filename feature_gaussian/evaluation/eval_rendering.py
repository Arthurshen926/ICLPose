...
用法:
    python -m feature_gaussian.evaluation.eval_rendering \
        --ply_path dataset/room_0/splatloc-test/data/room_0/point_cloud/final/point_cloud.ply \
        --checkpoint feature_gaussian/output/room_0_new/best_model.pth \
        ...
        --output_dir feature_gaussian/output/room_0_new/eval
"""
...
def parse_args():
    ...
    p.add_argument("--output_dir", type=str, default="feature_gaussian/output/eval", help="输出目录")
