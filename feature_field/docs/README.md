...
1. **FeatureGaussian**
   ...
   - Backing implementation: `feature_field/dcff/hybrid_gaussian.py`, `feature_gaussian/models/`

2. **FeatureField**
   - Scene-side feature field, renderer, map decoder, and train/eval shared DCFF runtime.
   - Primary entry: `feature_field/`
   - Backing implementation: `feature_field/dcff/`, `feature_field/runtime.py`, `feature_field/scripts/train_dcff_v5.py`
...
Legacy directories such as `feature_extraction/`, `place_recognition/`, `feature_gaussian/legacy_3dgs/`,
...
For the detailed teacher-to-map reconstruction workflow, see:

- [FEATURE_RECONSTRUCTION_WORKFLOW.md](FEATURE_RECONSTRUCTION_WORKFLOW.md)
...
- **FeatureField**: `python -m feature_field.train`, `python -m feature_field.evaluate`, `python -m feature_field.visualize_reconstruction`
...
- **FeatureField**: `feature_field/configs/dcff_oldhospital_v5a.yaml`
- **FeatureExtract**: `feature_extract/configs/joint_radio_dcff_oh_v5l_pointwise_featsharp_full.yaml`
- **FeatureExtract smoke/pilot**: `feature_extract/configs/joint_radio_dcff_oh_v5m_pointwise_teacher_anchor_pilot.yaml`
- **PoseRefine / FeatureRetrieval**: `pose_refine/configs/concat_loc_oh_v20k_v5g_student_querymap_adapt.yaml`
...
- Preferred locations:
   ...
   - geometry / scene assets: `feature_gaussian/output/2dgs_models/`
   - extracted features: `feature_extract/output/features_*/`
   - bundled third-party weights: `feature_extract/checkpoints/RADIO/`
