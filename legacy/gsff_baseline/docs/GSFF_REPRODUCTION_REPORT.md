...
**文件**: `legacy/gsff_baseline/scripts/train_gsff.py`
...
**文件**: `legacy/gsff_baseline/scripts/eval_gsff.py`
...
```bash
CUDA_VISIBLE_DEVICES=3 python legacy/gsff_baseline/scripts/train_gsff.py \
...
| `legacy/gsff_baseline/scripts/train_gsff.py` | ~815 | 训练入口 (GSFFTrainer) |
| `legacy/gsff_baseline/scripts/eval_gsff.py` | ~515 | 评估入口 (multi-start, multi-round) |
