...
def cmd_gsff_optim(args):
    ...
    print(f"    python legacy/gsff_baseline/scripts/visualize_gsff.py --checkpoint {args.checkpoint} \\")
    ...
    print(f"\n  或使用更详细的中间量可视化:")
    print(f"    python legacy/gsff_baseline/scripts/visualize_gsff_intermediates.py --checkpoint {args.checkpoint} ...")
