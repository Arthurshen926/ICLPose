#!/bin/bash
# Train 256d models with multiple seeds on GPU 3 and GPU 5
set -e
cd /root/ICLPose-loc
...
# ---- GPU 5: Wider architecture seeds ----
# Wider: [2048,1024,512] (same as best 128d config exp14n/p)
...
# Extra-wide: [4096,2048,1024] to handle 13312d input better
...
echo "=== All 256d training on GPU 5 complete! ==="
